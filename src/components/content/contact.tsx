            ...
            <div className="arlo_tm_section" id="contact">
                ...
                <div className="arlo_tm_footer_contact_wrapper_all">
                        ...
                        <div className="container">
                            <div className="leftbox">
                                ...
                                <div className="short_info_wrap">
                                    <ul>
                                        <li><p><label>Email:</label><span><a href="mailto:ads.hoidanit@gmail.com">ads.hoidanit@gmail.com</a></span></p></li>
                                        <li>
                                            <p><label>Website:</label>
                                                <span><a href="https://hoidanit.com.vn/" target="_blank">www.hoidanit.com.vn</a></span>
                                            </p>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div className="arlo_tm_footer_wrap">
                        <div className="container">
                            <p>&copy; Copyright 2023 by Hỏi Dân IT. All Rights are Reserved.</p>
                        </div>
                    </div>
                </div>
